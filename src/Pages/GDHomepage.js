    ...
    return (
      <div>
        ...
        <div className="contentWarpper">
          ...
          <Row className="buttomRow">
            <Col className="leftCol" span={12}>
              <div className="afaqCard">
                <div className="afaqHeading">Tasks</div>
                <p>{this.rotations[this.state.current].tasks}</p>
              </div>
            </Col>
            <Col className="rightCol" span={12}>
              <div className="afaqCard">
                <div className="afaqHeading">Skillsets</div>
